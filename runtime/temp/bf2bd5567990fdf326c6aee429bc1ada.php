<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:43:"../public/template/admin/rbac\showrule.html";i:1508002734;s:34:"../public/template/admin/base.html";i:1505581967;s:41:"../public/template/admin/Public\head.html";i:1506700089;s:43:"../public/template/admin/Public\header.html";i:1505574579;s:40:"../public/template/admin/Public\nav.html";i:1505581782;s:41:"../public/template/admin/Public\left.html";i:1507346914;s:43:"../public/template/admin/Public\footer.html";i:1506700052;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<div class="layui-body body">
		...
		<a class="layui-btn" href="<?php echo url('admin/Rbac/addRule'); ?>">
		...
		<table class="layui-table">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $v['rule_info']; ?></td>
					<td><?php echo $v['rule_name']; ?></td>
					<td>
						<?php switch($v['rule_status']): case "1": ?>显示<?php break; case "0": ?>隐藏<?php break; endswitch; ?>
					</td>
					<td>
						<a href="#" class="layui-btn">添加子菜单    </a>
						<a href="<?php echo url('admin/Rbac/deleteRule',['id'=> $v['rule_id']]); ?>}" class="layui-btn">删除   </a>
						<a href="<?php echo url('admin/Rbac/changeRule',['id'=> $v['rule_id']]); ?>" class="layui-btn">修改   </a>
					</td>
				</tr>
